...
| `converterConfig.contents` | string | The JSON content for the converter configuration `ConfigMap`.                                                                                           | See more details in the section `Converter Config configuration values`           |
