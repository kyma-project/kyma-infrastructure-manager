...
12. `registry-cache-config-controller-enabled` - feature flag responsible for enabling the RegistryCacheConfig Controller. Find more in [002-registry-cache.md](adr/002-registry-cache.md). Default value is `false`.
