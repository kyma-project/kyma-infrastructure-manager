...
// LoadImageToK3sClusterWithName loads a local docker image to the k3s cluster
func LoadImageToK3SClusterWithName(imageName, clusterName string) error {
	k3dOptions := []string{"image", "import", imageName, "-c", clusterName}
